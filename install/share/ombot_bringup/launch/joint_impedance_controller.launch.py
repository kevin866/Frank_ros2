...
def generate_launch_description():
    ...
    robot_controllers = PathJoinSubstitution(
        [
            ...
            "config",
            "ombot_controller.yaml",   # make sure this includes your impedanceCancelController
        ]
    )
    ...
    # Swap to your impedance controller name from YAML (e.g., "impedance_cancel_controller")
